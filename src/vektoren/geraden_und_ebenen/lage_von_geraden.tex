\subsection{Lage von Geraden (Schnitt-/Lotfußpunkt)}
Geraden können können zueinander \underline{Identisch}, 
\underline{Parallel} und \underline{Windschief} liegen.

Dabei kann man bei Windschiefen oder Parallel liegende Geraden den abstand berechnen. \\
Für Geraden die einen Schnittpunkt besitzen kann man direkt den 
\hyperref[sec:schnittpunkt_gerade]{Schnittpunkt}
berechnen.\\
Bei Geraden die \underline{keinen} Schnittpunkt besitzen kann man den geringsten Abstand, 
den \hyperref[sec:lotfußpunkt]{Lotfußpunkt} berechnen.

\subsubsection{Lotfußpunkt Berechnen}
\label{sec:lotfußpunkt}
